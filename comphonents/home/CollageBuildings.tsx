    ...
    <div className="absolute inset-0 z-20 pointer-events-none">
      <FloatingNode className="absolute left-[10%] bottom-[5%] md:left-[30%] md:bottom-[10%]" delay={0}>
        <div className="flex flex-col items-start space-y-1 drop-shadow-2xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-2">
            <span className="text-[#FF6A00] text-3xl md:text-4xl font-black tracking-tighter leading-none">
              AI-Driven ERP Suite
            </span>
            <div className="h-[2px] w-full bg-gradient-to-r from-[#FF6A00] to-transparent opacity-50 md:hidden" />
         ...
         <div className="hidden md:block h-[2px] w-full bg-gradient-to-r from-[#FF6A00] to-transparent opacity-50" />
        </div>
      </FloatingNode>
      ...
      <FloatingNode className="absolute left-[10%] top-[25%] md:left-[20%] md:top-[15%]" delay={0}>
        <div className="bg-[#181A20]/80 backdrop-blur-md rounded-xl shadow-2xl px-1 py-1 md:px-4 md:py-3 flex flex-col items-center border border-white/5">
          <BookOpen className="text-[#FF6A00] w-5 h-5 md:w-7 md:h-7 mb-1" />
      ...
      <FloatingNode className="absolute right-[35%] top-[15%] md:right-[30%] md:top-[15%]" delay={0}>
        <div className="bg-[#181A20]/80 backdrop-blur-md rounded-xl shadow-2xl px-1 py-1 md:px-4 md:py-3 flex flex-col items-center border border-white/5">
          <MessageSquare className="text-[#FF6A00] w-5 h-5 md:w-7 md:h-7 mb-1" />
      ...
      <FloatingNode className="absolute right-[10%] top-[25%]" delay={0.5}>
        <div className="bg-[#181A20]/80 backdrop-blur-md rounded-xl shadow-2xl px-1 py-1 md:px-4 md:py-3 flex flex-col items-center border border-white/5">
          <GraduationCap className="text-[#FF6A00] w-5 h-5 md:w-7 md:h-7 mb-1" />
      ...
      <FloatingNode className="absolute left-[78%] top-[70%] md:left-[78%] md:top-[55%]" delay={1.2}>
        <div className="bg-[#181A20] rounded-xl shadow-[0_0_30px_rgba(255,106,0,0.2)] px-1 py-1 md:px-4 md:py-3 flex flex-col items-center border border-[#FF6A00]/50">
          <DollarSign className="text-[#FF6A00] w-5 h-5 md:w-7 md:h-7 mb-1" />
      ...
      <FloatingNode className="absolute left-[35%] top-[73%] md:left-[15%] md:top-[40%]" delay={0.8}>
        <div className="bg-[#181A20]/80 backdrop-blur-md rounded-xl shadow-2xl px-1 py-1 md:px-4 md:py-3 flex flex-col items-center border border-white/5">
          <BarChart2 className="text-[#FF6A00] w-5 h-5 md:w-7 md:h-7 mb-1" />
      ...
      <FloatingNode className="absolute left-[5%] bottom-[25%] md:left-[25%] md:bottom-[25%]" delay={1.5}>
        <div className="bg-[#181A20]/80 backdrop-blur-md rounded-xl shadow-2xl px-1 py-1 md:px-4 md:py-3 flex flex-col items-center border border-white/5">
          <Home className="text-[#FF6A00] w-5 h-5 md:w-7 md:h-7 mb-1" />
