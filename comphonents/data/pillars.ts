...
export const pillars: PillarDataBase[] = [
  {
    ...
    subFeatures: [
      ...
      },
      {
        ...
        "description": "A centralized attendance management system that enables institutions to record, monitor, and manage faculty attendance with structured workflows, role-based access, and real-time updates.",
        "benefits": [
        ...
        "sections": [
          {
            "title": "Overview",
            "content": "The Faculty Attendance System in SCAMPUS provides a structured and efficient platform to manage the daily attendance of faculty members across departments. It allows College Admin and HOD to monitor attendance while enabling faculty to mark their own attendance when permitted. The system ensures accurate tracking based on department, date, and faculty records, improving transparency and operational efficiency.",
            "image": "https://img.freepik.com/free-vector/attendance-tracking-concept-illustration_114360-1006.jpg"
          },
          {
            "title": "Attendance Process",
            "content": "Users can mark attendance through a simple workflow by selecting the department, choosing the date, and viewing the list of faculty members. Attendance is recorded by selecting a status such as Present, Absent, or Leave for each faculty member. Once submitted, the system saves the attendance data and makes it instantly available for monitoring and reporting.",
            "image": "https://img.freepik.com/free-vector/checklist-concept-illustration_114360-1486.jpg"
          },
          {
            "title": "Role-Based Access & Control",
            "content": "The system follows a structured role-based model where College Admin has full access across all departments, HOD can manage attendance within their department, and faculty can mark their own attendance if enabled. Admin can configure permissions such as editing past records, enabling self-attendance, and defining attendance rules, ensuring secure and controlled operations.",
            "image": "https://supertokens.com/covers/what-is-rbac-cover.png"
          },
          {
            "title": "Tracking, Reports & System Behavior",
            "content": "The system ensures each faculty member has a single attendance record per day, preventing duplicate entries and maintaining data accuracy. Attendance updates happen in real time and can be filtered by department and date. Admin users can generate reports, monitor absentee patterns, and download attendance data, enabling efficient decision-making and institutional management.",
            "image": "https://img.freepik.com/free-vector/data-report-illustration-concept_114360-883.jpg"
          }
        ]
      },
    ...
    subFeatures: [
      {
        ...
        "description": "A centralized communication system that enables institutions to create, publish, and share announcements in real time with structured workflows, role-based access, and interactive engagement.",
        "benefits": [
        ...
        "sections": [
          {
            "title": "Overview",
            "content": "The News Feed System in SCAMPUS provides a centralized platform for sharing announcements, updates, and documents across the institution. Authorized users such as College Admin, Principal, HOD, and Teachers can create and publish posts, ensuring that important information is communicated efficiently. The system enhances transparency, accessibility, and engagement by making all published content visible to users in real time.",
            "image": "https://img.freepik.com/free-vector/news-concept-illustration_114360-2029.jpg"
          },
          {
            "title": "Post Creation & Publishing",
            "content": "Users can easily create posts through a simple and intuitive interface by entering text content or uploading documents such as PDFs and images. Before publishing, the system validates the content to ensure it is not empty and that uploaded files are valid. Once the user clicks the publish button, the post is saved and instantly made visible in the News Feed for all users.",
            "image": "https://img.freepik.com/free-vector/content-creator-concept-illustration_114360-2766.jpg"
          },
          {
            "title": "Role-Based Access & Visibility",
            "content": "The system follows a flexible role-based access model where multiple roles including College Admin, Principal, HOD, and Teachers can create and publish posts, while all authorized users can view and interact with them. Once a post is published, it becomes accessible to all users without hierarchical restrictions, ensuring consistent communication across the institution.",
            "image": "https://supertokens.com/covers/what-is-rbac-cover.png"
          },
          {
            "title": "User Interaction & System Behavior",
            "content": "All published posts are displayed in a latest-first order, allowing users to quickly access recent updates. Each post includes details such as the creator's name, content or attached document, and published time. Users can interact with posts through actions like liking, improving engagement within the platform. The system ensures only valid and published content is visible, maintaining a clean and organized News Feed experience.",
            "image": "https://img.freepik.com/free-vector/social-media-concept-illustration_114360-267.jpg"
          }
        ]
      },
      {
